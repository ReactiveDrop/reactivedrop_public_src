...
#define ACH_ASW_NO_CHALLENGES				0x2000		// this flag and the next are cosmetic only and mutually exclusive; logic is implemented elsewhere
#define ACH_ASW_OUTSTANDING_EXECUTION		0x4000		// cannot be earned if any challenge was active or any marine died during the current campaign save
