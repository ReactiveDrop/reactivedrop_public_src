...
{
	V_strncpy(szKey, other.szKey, sizeof(szKey));
	V_strncpy(szValue, other.szValue, sizeof(szValue));
...
void WCKVBase_Vector::AddKeyValue(const char *pszKey, const char *pszValue)
{
	...
	V_strncpy(szTmpKey, pszKey, sizeof(szTmpKey));
	V_strncpy(szTmpValue, pszValue, sizeof(szTmpValue));
	...
	//
	MDkeyvalue newkv;
	V_strncpy(newkv.szKey, szTmpKey, sizeof(newkv.szKey));
	V_strncpy(newkv.szValue, szTmpValue, sizeof(newkv.szValue));
