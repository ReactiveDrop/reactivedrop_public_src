...
// This can go away when everything is in bin.
	...
	void Error( _Printf_format_string_ char const *pMsg, ... );
#else
	#include "tier0/dbg.h"
#endif
...
void CmdLib_FPrintf( FileHandle_t hFile, _Printf_format_string_ const char *pFormat, ... );
...
void ColorPrintf( FILE *pFile, bool red, bool green, bool blue, bool intensity, _Printf_format_string_ char const *pFormat, ... );
...
void qprintf( _Printf_format_string_ const char *format, ... );
