...
#define ASW_COMPUTER_MAX_MENU_ITEMS 6
...
class CASW_VGUI_Computer_Menu : public vgui::Panel, public CASW_VGUI_Ingame_Panel
{
	...
	void ASWInit();
	void SetIcons();
	void SetIcon( int icon, const char *szLabel, const char *szIcon, bool bLocked );
	...
	bool m_bMenuLocked[ASW_COMPUTER_MAX_MENU_ITEMS];
