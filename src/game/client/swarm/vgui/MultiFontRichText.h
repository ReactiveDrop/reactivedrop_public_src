...
public:
	...
	void InsertZbalermornaChar( char ch );
	void InsertZbalermornaString( const char *text );
...
private:
	...
	int DrawString(int iFirst, int iLast, TRenderState &renderState);
};
