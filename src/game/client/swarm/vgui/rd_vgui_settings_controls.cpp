...
// Scripted user functions are keyboard-only until their Steam Input actions and
	...
	BaseClass( parent, panelName )
{
	...
	// Custom functions
	m_pBindTraitorsUseSkill = new CRD_VGUI_KeyboardBind( this, "BindTraitorsUseSkill", "#rd_traitors_use_skill", "scripted_user_func traitors_use_skill", true );
	m_pBindTraitorsGameplayInfo = new CRD_VGUI_KeyboardBind( this, "BindTraitorsGameplayInfo", "#rd_traitors_gameplay_info", "scripted_user_func traitors_gameplay_info", true );
