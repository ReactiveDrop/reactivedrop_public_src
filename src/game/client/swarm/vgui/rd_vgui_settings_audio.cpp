...
{
	m_pMixerOverallVolume = new CRD_VGUI_Option_Mixer( this, "MixerOverallVolume", "#GameUI_SoundEffectVolume", "null_looped.wav" );
	...
	m_pMixerMusicInGame = new CRD_VGUI_Option_Mixer( this, "MixerMusicInGame", "#rd_mixer_volume_music_ingame_label", "music/volume_preview.wav" );
	m_pMixerMusicInGame->SetDefaultHint( "#rd_mixer_volume_music_ingame_tooltip" );
	m_pMixerMusicInGame->SetSliderMinMax( 0.0f, 1.5f );
	m_pMixerMusicInGame->LinkToConVar( "rd_mixer_volume_music_ingame", true );
	m_pMixerVoiceDialogue = new CRD_VGUI_Option_Mixer( this, "MixerVoiceDialogue", "#rd_mixer_volume_voice_dialogue_label", "vo/command/volume_preview.wav" );
	m_pMixerVoiceDialogue->SetDefaultHint( "#rd_mixer_volume_voice_dialogue_tooltip" );
	m_pMixerVoiceDialogue->SetSliderMinMax( 0.0f, 1.5f );
	m_pMixerVoiceDialogue->LinkToConVar( "rd_mixer_volume_voice_dialogue", true );
	m_pMixerVoicePlayers = new CRD_VGUI_Option_Mixer( this, "MixerVoicePlayers", "#rd_mixer_volume_voice_players_label", "null_looped.wav" );
	m_pMixerVoicePlayers->SetDefaultHint( "#rd_mixer_volume_voice_players_tooltip" );
	m_pMixerVoicePlayers->SetSliderMinMax( 0.0f, 1.5f );
	m_pMixerVoicePlayers->LinkToConVar( "rd_mixer_volume_voice_players", true );
	m_pMixerVoiceAliens = new CRD_VGUI_Option_Mixer( this, "MixerVoiceAliens", "#rd_mixer_volume_voice_aliens_label", "aliens/voc/volume_preview.wav" );
	m_pMixerVoiceAliens->SetDefaultHint( "#rd_mixer_volume_voice_aliens_tooltip" );
	m_pMixerVoiceAliens->SetSliderMinMax( 0.0f, 1.5f );
	m_pMixerVoiceAliens->LinkToConVar( "rd_mixer_volume_voice_aliens", true );
	m_pMixerInterface = new CRD_VGUI_Option_Mixer( this, "MixerInterface", "#rd_mixer_volume_interface_label", "swarm/interface/volume_preview.wav" );
	m_pMixerInterface->SetDefaultHint( "#rd_mixer_volume_interface_tooltip" );
	m_pMixerInterface->SetSliderMinMax( 0.0f, 1.5f );
	m_pMixerInterface->LinkToConVar( "rd_mixer_volume_interface", true );
	m_pMixerEnvironmentAmbient = new CRD_VGUI_Option_Mixer( this, "MixerEnvironmentAmbient", "#rd_mixer_volume_environment_ambient_label", "ambient/volume_preview.wav" );
	m_pMixerEnvironmentAmbient->SetDefaultHint( "#rd_mixer_volume_environment_ambient_tooltip" );
	...
	m_pMixerEnvironmentPhysics = new CRD_VGUI_Option_Mixer( this, "MixerEnvironmentPhysics", "#rd_mixer_volume_environment_physics_label", "physics/volume_preview.wav" );
	m_pMixerEnvironmentPhysics->SetDefaultHint( "#rd_mixer_volume_environment_physics_tooltip" );
	...
	m_pMixerCombatDamage = new CRD_VGUI_Option_Mixer( this, "MixerCombatDamage", "#rd_mixer_volume_combat_damage_label", "physics/2D/damage/volume_preview.wav" );
	m_pMixerCombatDamage->SetDefaultHint( "#rd_mixer_volume_combat_damage_tooltip" );
	m_pMixerCombatDamage->SetSliderMinMax( 0.0f, 1.5f );
	m_pMixerCombatDamage->LinkToConVar( "rd_mixer_volume_combat_damage", true );
	m_pMixerCombatWeapons = new CRD_VGUI_Option_Mixer( this, "MixerCombatWeapons", "#rd_mixer_volume_combat_weapons_label", "weapons/volume_preview.wav" );
	m_pMixerCombatWeapons->SetDefaultHint( "#rd_mixer_volume_combat_weapons_tooltip" );
	m_pMixerCombatWeapons->SetSliderMinMax( 0.0f, 1.5f );
	m_pMixerCombatWeapons->LinkToConVar( "rd_mixer_volume_combat_weapons", true );
	m_pMixerExplosions = new CRD_VGUI_Option_Mixer( this, "MixerExplosions", "#rd_mixer_volume_explosions_label", "explosions/volume_preview.wav" );
	m_pMixerExplosions->SetDefaultHint( "#rd_mixer_volume_explosions_tooltip" );
	m_pMixerExplosions->SetSliderMinMax( 0.0f, 1.5f );
	m_pMixerExplosions->LinkToConVar( "rd_mixer_volume_explosions", true );
	m_pMixerOther = new CRD_VGUI_Option_Mixer( this, "MixerOther", "#rd_mixer_volume_other_label", "swarm/volume_preview.wav" );
	m_pMixerOther->SetDefaultHint( "#rd_mixer_volume_other_tooltip" );
