...
IMPLEMENT_CLIENTCLASS_DT( C_ASW_Computer_Area, DT_ASW_Computer_Area, CASW_Computer_Area )
	...
	RecvPropEHandle( RECVINFO( m_hCustomHack ) ),
	...
	RecvPropEHandle( RECVINFO( m_hCustomScreen1 ) ),
	RecvPropEHandle( RECVINFO( m_hCustomScreen2 ) ),
	RecvPropEHandle( RECVINFO( m_hCustomScreen3 ) ),
	RecvPropEHandle( RECVINFO( m_hCustomScreen4 ) ),
	RecvPropEHandle( RECVINFO( m_hCustomScreen5 ) ),
	RecvPropEHandle( RECVINFO( m_hCustomScreen6 ) ),
	...
	RecvPropInt( RECVINFO( m_iLockedScreens ) ),
