...
class CAchievement_Server_Triggered_No_Challenges : public CASW_Achievement
{
	void Init()
	{
		SetFlags( ACH_SAVE_GLOBAL | ACH_ASW_NO_CHALLENGES );
		SetGoal( 1 );
	}
	// server fires an event for this achievement, no other code within achievement necessary
};
...
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_ASW_NO_DAMAGE_TAKEN, "ASW_NO_DAMAGE_TAKEN", 5, 50 );
...
{ \
	void Init() \
	{ \
		SetFlags( ACH_SAVE_GLOBAL | ACH_HAS_COMPONENTS | ACH_ASW_NO_CHALLENGES ); \
		SetStoreProgressInSteam( true ); \
...
DIFFICULTY_CAMPAIGN_ACHIEVEMENTS(205, RD_, _CAMPAIGN_REDUCTION, Reduction);
#ifdef RD__CAMPAIGNS_DEADCITY
DIFFICULTY_CAMPAIGN_ACHIEVEMENTS(210, RD_, _CAMPAIGN_DC, DC);
#endif
#ifdef RD_6A_CAMPAIGNS_ADANAXIS
DIFFICULTY_CAMPAIGN_ACHIEVEMENTS(215, RD_, _CAMPAIGN_ADA, ADA);
#endif
...
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_ASW_SPEEDRUN_LANDING_BAY, "ASW_SPEEDRUN_LANDING_BAY", 5, 1230 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_ASW_SPEEDRUN_DESCENT, "ASW_SPEEDRUN_DESCENT", 5, 1231 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_ASW_SPEEDRUN_DEIMA, "ASW_SPEEDRUN_DEIMA", 5, 1232 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_ASW_SPEEDRUN_RYDBERG, "ASW_SPEEDRUN_RYDBERG", 5, 1233 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_ASW_SPEEDRUN_RESIDENTIAL, "ASW_SPEEDRUN_RESIDENTIAL", 5, 1234 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_ASW_SPEEDRUN_SEWER, "ASW_SPEEDRUN_SEWER", 5, 1235 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_ASW_SPEEDRUN_TIMOR, "ASW_SPEEDRUN_TIMOR", 5, 1236 );

#define DECLARE_RD_SPEEDRUN_ACHIEVEMENT( suffix, order ) \
	DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_RD_SPEEDRUN_ ## suffix, "RD_SPEEDRUN_" #suffix, 5, order )
...
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( REDUCTION_SILENTSTATION, 1290 );
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( REDUCTION_OPSANDSTORM, 1291 );
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( REDUCTION_FALLENCITY, 1292 );
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( REDUCTION_STOWAWAY, 1293 );
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( REDUCTION_INEVITABLEESCALATION, 1294 );
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( REDUCTION_NUCLEARESCORT, 1295 );

#ifdef RD_6A_CAMPAIGNS_ADANAXIS
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( ADA_SECTOR_A9, 1296 );
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( ADA_NEXUS_SUBNODE, 1297 );
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( ADA_NEON_CARNAGE, 1298 );
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( ADA_FUEL_JUNCTION, 1299 );
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( ADA_DARK_PATH, 1300 );
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( ADA_FORBIDDEN_OUTPOST, 1301 );
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( ADA_NEW_BEGINNING, 1302 );
DECLARE_RD_SPEEDRUN_ACHIEVEMENT( ADA_ANOMALY, 1303 );
#endif
...
class CAchievement_Outstanding_Execution : public CASW_Achievement
{
	void Init()
	{
		SetFlags( ACH_SAVE_GLOBAL | ACH_ASW_OUTSTANDING_EXECUTION );
		SetGoal( 1 );
	}
	// server fires an event for this achievement, no other code within achievement necessary
};

DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_ASW_CAMPAIGN_NO_DEATHS, "ASW_CAMPAIGN_NO_DEATHS", 5, 1000 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_OCS, "RD_CAMPAIGN_NO_DEATHS_OCS", 5, 1001 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_RES, "RD_CAMPAIGN_NO_DEATHS_RES", 5, 1002 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_AREA9800, "RD_CAMPAIGN_NO_DEATHS_AREA9800", 5, 1003 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_TFT, "RD_CAMPAIGN_NO_DEATHS_TFT", 5, 1004 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_TIL, "RD_CAMPAIGN_NO_DEATHS_TIL", 5, 1006 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_LAN, "RD_CAMPAIGN_NO_DEATHS_LAN", 5, 1007 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_PAR, "RD_CAMPAIGN_NO_DEATHS_PAR", 5, 1009 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_NH, "RD_CAMPAIGN_NO_DEATHS_NH", 5, 1010 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_BIO, "RD_CAMPAIGN_NO_DEATHS_BIO", 5, 1011 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_ACC, "RD_CAMPAIGN_NO_DEATHS_ACC", 5, 1012 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_REDUCTION, "RD_CAMPAIGN_NO_DEATHS_REDUCTION", 5, 1013 );
#ifdef RD__CAMPAIGNS_DEADCITY
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_DC, "RD_CAMPAIGN_NO_DEATHS_DC", 5, 1014 );
#endif
#ifdef RD_6A_CAMPAIGNS_ADANAXIS
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Outstanding_Execution, ACHIEVEMENT_RD_CAMPAIGN_NO_DEATHS_ADA, "RD_CAMPAIGN_NO_DEATHS_ADA", 5, 1015 );
#endif
...
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_RD_MA_SCORE_POINTS, "RD_MA_SCORE_POINTS", 5, 3187 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_RD_MA_REACH_VOLCANO_ALIVE, "RD_MA_REACH_VOLCANO_ALIVE", 5, 3188 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_RD_MA_VISIT_EACH_ZONE, "RD_MA_VISIT_EACH_ZONE", 5, 3189 );
DECLARE_ACHIEVEMENT_ORDER( CAchievement_Server_Triggered_No_Challenges, ACHIEVEMENT_RD_ACC_MUONGEM_KILL, "RD_ACC_MUONGEM_KILL", 5, 3190 );
