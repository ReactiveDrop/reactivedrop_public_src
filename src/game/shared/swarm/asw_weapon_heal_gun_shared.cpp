...
bool CASW_Weapon_Heal_Gun::ShouldDimLaserPointer()
{
...
bool CASW_Weapon_Heal_Gun::IsFiring()
{
	return m_FireState != ASW_HG_FIRE_OFF;
}

void CASW_Weapon_Heal_Gun::ClearIsFiring()
{
