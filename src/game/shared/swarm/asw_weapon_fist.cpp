...
ConVar asw_fist_finisher_damage_scale( "asw_fist_finisher_damage_scale", "21.0f", FCVAR_REPLICATED | FCVAR_CHEAT, "Damage scale applied (in addition to passive scale) on combo finisher with fist" );
