...
ConVar asw_fist_passive_damage_scale( "asw_fist_passive_damage_scale", "3.5f", FCVAR_REPLICATED | FCVAR_CHEAT, "Damage scale applied from charged fist passive item" );
