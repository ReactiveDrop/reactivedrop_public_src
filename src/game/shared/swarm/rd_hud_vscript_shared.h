...
public:
	...
	CNetworkHandle( CBaseEntity, m_hDataEntity1 );
	CNetworkHandle( CBaseEntity, m_hDataEntity2 );
	CNetworkHandle( CBaseEntity, m_hDataEntity3 );
	CNetworkHandle( CBaseEntity, m_hDataEntity4 );
	CNetworkHandle( CBaseEntity, m_hDataEntity5 );
	CNetworkHandle( CBaseEntity, m_hDataEntity6 );
	CNetworkHandle( CBaseEntity, m_hDataEntity7 );
	CNetworkHandle( CBaseEntity, m_hDataEntity8 );
	CNetworkHandle( CBaseEntity, m_hDataEntity9 );
	CNetworkHandle( CBaseEntity, m_hDataEntity10 );
	CNetworkHandle( CBaseEntity, m_hDataEntity11 );
	CNetworkHandle( CBaseEntity, m_hDataEntity12 );
	CNetworkHandle( CBaseEntity, m_hDataEntity13 );
	CNetworkHandle( CBaseEntity, m_hDataEntity14 );
	CNetworkHandle( CBaseEntity, m_hDataEntity15 );
