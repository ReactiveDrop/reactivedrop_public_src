...
#define ASW_DEFAULT_COMMANDER_FACE "briefing/face_pilot"
	...
	ConVar rd_auto_kick_low_level_player_if_brutal_or_asbi( "rd_auto_kick_low_level_player_if_brutal_or_asbi", "1", FCVAR_NONE, "Server auto kicks players below level 34 if difficulty is brutal or asbi active" );
