...
#define ASW_DEFAULT_COMMANDER_FACE "briefing/face_pilot"
	...
	ConVar rd_auto_kick_low_level_player_if_brutal_or_challenge( "rd_auto_kick_low_level_player_if_brutal_or_challenge", "0", FCVAR_NONE, "Server auto kicks players below level 31 if difficulty is brutal or a challenge is active" );
	ConVar rd_auto_kick_low_level_player_if_brutal_or_asbi("rd_auto_kick_low_level_player_if_brutal_or_asbi", "1", FCVAR_NONE, "Server auto kicks players below level 31 if difficulty is brutal or asbi active");
