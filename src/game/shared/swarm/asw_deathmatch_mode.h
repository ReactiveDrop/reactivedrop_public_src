...
public:
	...
	void TeamDeathmatchDisable(bool enable_weapon_respawn_timer = true);
...
private:
	...
	*/
	...
	// these static variables are used to preserve the value between map changes
	// they are read in constructor and written in destructor and are equal to
	// the network variables that are below
	static RdGameModes game_mode_; 
...
private:
	...
	bool frags_left_said[RD_FRAGS_LEFT_SIZE];
