...
#define ASW_SUBSKILL_ENUM \
	...
	ENUM_ITEM( AUTOGUN, AUTOGUN_CRYO_FREEZE, 4 ) \
	ENUM_ITEM( AUTOGUN, AUTOGUN_CRYO_RADIUS, 5 ) \
	\
	...
	ENUM_ITEM( ACCURACY, ACCURACY_SHIELD_DMG, 19 ) \
	ENUM_ITEM( ACCURACY, ACCURACY_PLASMA_THROWER_DMG, 20 ) \
	\
