...
BEGIN_DATADESC( CNPC_BaseZombie )
	...
	DEFINE_KEYFIELD( m_iszNormalModel, FIELD_STRING, "normal_model" ),
	DEFINE_KEYFIELD( m_iszTorsoModel, FIELD_STRING, "torso_model" ),
	DEFINE_KEYFIELD( m_iszLegsModel, FIELD_STRING, "legs_model" ),
