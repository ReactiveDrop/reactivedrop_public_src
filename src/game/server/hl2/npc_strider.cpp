...
ConVar strider_immolate( "strider_immolate", "0", FCVAR_CHEAT );
ConVar sk_strider_health( "sk_strider_health", "350", FCVAR_CHEAT );
ConVar npc_strider_height_adj("npc_strider_height_adj", "0", FCVAR_CHEAT );
ConVar strider_eyepositions( "strider_eyepositions", "0", FCVAR_CHEAT );
ConVar strider_show_focus( "strider_show_focus", "0", FCVAR_CHEAT );
ConVar strider_distributed_fire( "strider_distributed_fire", "1", FCVAR_CHEAT );
ConVar strider_show_cannonlos( "strider_show_cannonlos", "0", FCVAR_CHEAT );
ConVar strider_show_weapon_los_z( "strider_show_weapon_los_z", "0", FCVAR_CHEAT );
ConVar strider_show_weapon_los_condition( "strider_show_weapon_los_condition", "0", FCVAR_CHEAT );
ConVar strider_idle_test( "strider_idle_test", "0", FCVAR_CHEAT );
ConVar strider_always_use_procedural_height( "strider_always_use_procedural_height", "0", FCVAR_CHEAT );
ConVar strider_test_height( "strider_test_height", "0", FCVAR_CHEAT );
ConVar strider_pct_height_no_crouch_move( "strider_pct_height_no_crouch_move", "90", FCVAR_CHEAT );

ConVar strider_peek_time( "strider_peek_time", "0.75", FCVAR_CHEAT );
ConVar strider_peek_time_after_damage( "strider_peek_time_after_damage", "4.0", FCVAR_CHEAT );
ConVar strider_peek_eye_dist( "strider_peek_eye_dist", "1.75", FCVAR_CHEAT );
ConVar strider_peek_eye_dist_z( "strider_peek_eye_dist_z", "4.0", FCVAR_CHEAT );
ConVar strider_free_pass_start_time( "strider_free_pass_start_time", "3", FCVAR_CHEAT );
ConVar strider_free_pass_cover_dist( "strider_free_pass_cover_dist", "120", FCVAR_CHEAT );
ConVar strider_free_pass_duration( "strider_free_pass_duration", "2", FCVAR_CHEAT );
ConVar strider_free_pass_refill_rate( "strider_free_pass_refill_rate", "0.5", FCVAR_CHEAT );
ConVar strider_free_pass_move_tolerance( "strider_free_pass_move_tolerance", "320", FCVAR_CHEAT );
ConVar strider_free_knowledge( "strider_free_knowledge", "0.5", FCVAR_CHEAT );

ConVar strider_free_pass_after_escorts_dead( "strider_free_pass_after_escorts_dead", "2.5", FCVAR_CHEAT );
ConVar strider_free_pass_tolerance_after_escorts_dead( "strider_free_pass_tolerance_after_escorts_dead", "600", FCVAR_CHEAT );

ConVar npc_strider_shake_ropes_radius( "npc_strider_shake_ropes_radius", "1200", FCVAR_CHEAT );
ConVar npc_strider_shake_ropes_magnitude( "npc_strider_shake_ropes_magnitude", "150", FCVAR_CHEAT );

ConVar strider_ar2_altfire_dmg( "strider_ar2_altfire_dmg", "25", FCVAR_CHEAT );

// Number of RPG hits it takes to kill a strider on each skill level.
ConVar sk_strider_num_missiles1( "sk_strider_num_missiles1", "5", FCVAR_CHEAT );
ConVar sk_strider_num_missiles2( "sk_strider_num_missiles2", "7", FCVAR_CHEAT );
ConVar sk_strider_num_missiles3( "sk_strider_num_missiles3", "7", FCVAR_CHEAT );

ConVar strider_missile_suppress_dist( "strider_missile_suppress_dist", "240", FCVAR_CHEAT );
ConVar strider_missile_suppress_time( "strider_missile_suppress_time", "3", FCVAR_CHEAT );
	...
	case TASK_STRIDER_FALL_TO_GROUND:
		{
			...
			vecVelocity.z -= (sv_gravity.GetFloat() * GetGravity() * 0.1);
...
void CNPC_Strider::FootFX( const Vector &origin )
{
	...
	if ( UTIL_PointContents( tr.endpos + Vector( 0, 0, 1 ), MASK_ALL ) & MASK_WATER )
	{
