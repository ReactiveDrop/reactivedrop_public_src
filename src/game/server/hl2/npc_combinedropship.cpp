...
ConVar	g_debug_dropship( "g_debug_dropship", "0", FCVAR_CHEAT );
ConVar  sk_dropship_container_health( "sk_dropship_container_health", "750", FCVAR_CHEAT );
ConVar	sk_npc_dmg_dropship( "sk_npc_dmg_dropship", "2", FCVAR_CHEAT, "Dropship container cannon damage." );
...
int CCombineDropshipContainer::OnTakeDamage( const CTakeDamageInfo &info )
{
	...
	// Airboat guns + explosive damage is all that can hurt it (removed DMG_AIRBOAT as it is DMG_INFEST here)
