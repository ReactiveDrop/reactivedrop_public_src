...
extern ConVar asw_new_drone;

#define	SWARM_DRONE_UBER_MODEL	"models/swarm/drone/UberDrone.mdl"
#define	SWARM_NEW_DRONE_UBER_MODEL	"models/aliens/drone/uberdrone.mdl"

CASW_Drone_Uber::CASW_Drone_Uber()	
{
	if ( asw_new_drone.GetBool() )
	{
		m_pszAlienModelName = SWARM_NEW_DRONE_UBER_MODEL;
	}
	else
	{
		m_pszAlienModelName = SWARM_DRONE_UBER_MODEL;
	}
}
...
{
	PrecacheModel( SWARM_NEW_DRONE_UBER_MODEL );
