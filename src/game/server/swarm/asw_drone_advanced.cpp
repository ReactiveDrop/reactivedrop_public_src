...
ConVar rd_drone_flinch_resets_attack( "rd_drone_flinch_resets_attack", "1", FCVAR_CHEAT, "Set to 1 to revert the fix for drones being able to attack immediately after a flinch interrupts an attack animation" );
