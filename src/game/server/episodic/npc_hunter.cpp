...
ConVar sk_hunter_health( "sk_hunter_health", "210", FCVAR_CHEAT );
...
ConVar hunter_flechette_min_range( "hunter_flechette_min_range", "100", FCVAR_CHEAT );
ConVar hunter_flechette_volley_size( "hunter_flechette_volley_size", "8", FCVAR_CHEAT );
ConVar hunter_flechette_speed( "hunter_flechette_speed", "2000", FCVAR_CHEAT );
ConVar sk_hunter_dmg_flechette( "sk_hunter_dmg_flechette", "4.0", FCVAR_CHEAT );
ConVar sk_hunter_flechette_explode_dmg( "sk_hunter_flechette_explode_dmg", "12.0", FCVAR_CHEAT );
ConVar sk_hunter_flechette_explode_radius( "sk_hunter_flechette_explode_radius", "128.0", FCVAR_CHEAT );
ConVar hunter_flechette_explode_delay( "hunter_flechette_explode_delay", "2.5", FCVAR_CHEAT );
ConVar hunter_flechette_delay( "hunter_flechette_delay", "0.1", FCVAR_CHEAT );
ConVar hunter_first_flechette_delay( "hunter_first_flechette_delay", "0.5", FCVAR_CHEAT );
ConVar hunter_flechette_max_concurrent_volleys( "hunter_flechette_max_concurrent_volleys", "2", FCVAR_CHEAT );
ConVar hunter_flechette_volley_start_min_delay( "hunter_flechette_volley_start_min_delay", ".25", FCVAR_CHEAT );
ConVar hunter_flechette_volley_start_max_delay( "hunter_flechette_volley_start_max_delay", ".95", FCVAR_CHEAT );
ConVar hunter_flechette_volley_end_min_delay( "hunter_flechette_volley_end_min_delay", "1", FCVAR_CHEAT );
ConVar hunter_flechette_volley_end_max_delay( "hunter_flechette_volley_end_max_delay", "2", FCVAR_CHEAT );
ConVar hunter_flechette_test( "hunter_flechette_test", "0", FCVAR_CHEAT );
ConVar hunter_clamp_shots( "hunter_clamp_shots", "1", FCVAR_CHEAT );
ConVar hunter_cheap_explosions( "hunter_cheap_explosions", "1", FCVAR_CHEAT );

// Damage received
ConVar sk_hunter_bullet_damage_scale( "sk_hunter_bullet_damage_scale", "0.6", FCVAR_CHEAT );
ConVar sk_hunter_charge_damage_scale( "sk_hunter_charge_damage_scale", "2.0", FCVAR_CHEAT );
ConVar sk_hunter_buckshot_damage_scale( "sk_hunter_buckshot_damage_scale", "0.5", FCVAR_CHEAT );
ConVar sk_hunter_vehicle_damage_scale( "sk_hunter_vehicle_damage_scale", "2.2", FCVAR_CHEAT );
ConVar sk_hunter_dmg_from_striderbuster( "sk_hunter_dmg_from_striderbuster", "150", FCVAR_CHEAT );
ConVar sk_hunter_citizen_damage_scale( "sk_hunter_citizen_damage_scale", "0.3", FCVAR_CHEAT );

ConVar hunter_allow_dissolve( "hunter_allow_dissolve", "1", FCVAR_CHEAT );
ConVar hunter_random_expressions( "hunter_random_expressions", "0", FCVAR_CHEAT );
ConVar hunter_show_weapon_los_z( "hunter_show_weapon_los_z", "0", FCVAR_CHEAT );
ConVar hunter_show_weapon_los_condition( "hunter_show_weapon_los_condition", "0", FCVAR_CHEAT );

ConVar hunter_melee_delay( "hunter_melee_delay", "2.0", FCVAR_CHEAT );

// Bullrush charge.
ConVar hunter_charge( "hunter_charge", "1", FCVAR_CHEAT );
ConVar hunter_charge_min_delay( "hunter_charge_min_delay", "10.0", FCVAR_CHEAT );
ConVar hunter_charge_pct( "hunter_charge_pct", "25", FCVAR_CHEAT );
ConVar hunter_charge_test( "hunter_charge_test", "0", FCVAR_CHEAT );

// Vehicle dodging.
ConVar hunter_dodge_warning( "hunter_dodge_warning", "1.1", FCVAR_CHEAT );
ConVar hunter_dodge_warning_width( "hunter_dodge_warning_width", "180", FCVAR_CHEAT );
ConVar hunter_dodge_warning_cone( "hunter_dodge_warning_cone", ".5", FCVAR_CHEAT );
ConVar hunter_dodge_debug( "hunter_dodge_debug", "0", FCVAR_CHEAT );

// Jostle vehicles when hit by them
ConVar hunter_jostle_car_min_speed( "hunter_jostle_car_min_speed", "100", FCVAR_CHEAT ); // If hit by a car going at least this fast, jostle the car
ConVar hunter_jostle_car_max_speed( "hunter_jostle_car_max_speed", "600", FCVAR_CHEAT ); // Used for determining jostle scale

ConVar hunter_free_knowledge( "hunter_free_knowledge", "10.0", FCVAR_CHEAT );
ConVar hunter_plant_adjust_z( "hunter_plant_adjust_z", "12", FCVAR_CHEAT );

ConVar hunter_disable_patrol( "hunter_disable_patrol", "0", FCVAR_CHEAT );

// Dealing with striderbusters
ConVar hunter_hate_held_striderbusters( "hunter_hate_held_striderbusters", "1", FCVAR_CHEAT );
ConVar hunter_hate_thrown_striderbusters( "hunter_hate_thrown_striderbusters", "1", FCVAR_CHEAT );
ConVar hunter_hate_attached_striderbusters( "hunter_hate_attached_striderbusters", "1", FCVAR_CHEAT );
ConVar hunter_hate_held_striderbusters_delay( "hunter_hate_held_striderbusters_delay", "0.5", FCVAR_CHEAT );
ConVar hunter_hate_held_striderbusters_tolerance( "hunter_hate_held_striderbusters_tolerance", "2000.0", FCVAR_CHEAT );
ConVar hunter_hate_thrown_striderbusters_tolerance( "hunter_hate_thrown_striderbusters_tolerance", "300.0", FCVAR_CHEAT );
ConVar hunter_seek_thrown_striderbusters_tolerance( "hunter_seek_thrown_striderbusters_tolerance", "400.0", FCVAR_CHEAT );
ConVar hunter_retreat_striderbusters( "hunter_retreat_striderbusters", "1", FCVAR_CHEAT, "If true, the hunter will retreat when a buster is glued to him." );

ConVar hunter_allow_nav_jump( "hunter_allow_nav_jump", "0", FCVAR_CHEAT );
ConVar g_debug_hunter_charge( "g_debug_hunter_charge", "0", FCVAR_CHEAT );

ConVar hunter_stand_still( "hunter_stand_still", "0", FCVAR_CHEAT ); // used for debugging, keeps them rooted in place

ConVar hunter_siege_frequency( "hunter_siege_frequency", "12", FCVAR_CHEAT );
...
void CHunterFlechette::StickTo( CBaseEntity *pOther, trace_t &tr )
{
	...
	if ( s_nImpactCount & 0x01 )
	{
		...
		// Shoot some sparks
		if ( UTIL_PointContents( GetAbsOrigin(), MASK_ALL ) != CONTENTS_WATER)
		{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
class CNPC_Hunter : public CASW_Inhabitable_NPC
{
	DECLARE_CLASS( CNPC_Hunter, CASW_Inhabitable_NPC );
...
private:
	...
	float	m_flMinigunDistZ;
	Vector	m_vecLocalRelativePositionMinigun;

	int m_nTopGunAttachment;
	int m_nBottomGunAttachment;
	int m_nAimYawPoseParam;
	int m_nAimPitchPoseParam;
	int m_nBodyYawPoseParam;
	int m_nBodyPitchPoseParam;
	int m_nStaggerYawPoseParam;
	int m_nHeadCenterAttachment;
	int m_nHeadBottomAttachment;
	float m_flHeadRadius;

	int m_nUnplantedNode;
	int m_nPlantedNode;
...
void CNPC_Hunter::Precache()
{
	if ( !GetModelName() )
	{
		SetModelName( MAKE_STRING( "models/hunter.mdl" ) );
	}
...
void CNPC_Hunter::SetupGlobalModelData()
{
	...
	m_nBodyYawPoseParam = LookupPoseParameter( "body_yaw" );
	...
	GetAttachment( m_nHeadCenterAttachment, vecHeadCenter );
	GetAttachment( m_nHeadBottomAttachment, vecHeadBottom );
	m_flHeadRadius = ( vecHeadCenter - vecHeadBottom ).Length();

	int nSequence = SelectWeightedSequence( ACT_HUNTER_RANGE_ATTACK2_UNPLANTED );
	m_nUnplantedNode = GetEntryNode( nSequence );

	nSequence = SelectWeightedSequence( ACT_RANGE_ATTACK2 );
	m_nPlantedNode = GetEntryNode( nSequence );
...
void CNPC_Hunter::Activate()
{
	...
	// Repeating this block for every spawn makes hunters more expensive to spawn in AS:RD,
	// but if we don't do it, we have to hard-code the hunter model.
	{
		...
		m_flMinigunDistZ = defEyePos.z - pHunter->GetAbsOrigin().z;

		Vector position;
		pHunter->GetAttachment( m_nTopGunAttachment, position );
		VectorITransform( position, pHunter->EntityToWorldTransform(), m_vecLocalRelativePositionMinigun );
		UTIL_Remove( pHunter );
	}
}
...
{ 
	Vector vecResult;
	QAngle vecAngle;
	GetAttachment( m_nHeadCenterAttachment, vecResult, vecAngle );

	if ( bNoisy )
	{
		float rand1 = random->RandomFloat( 0, m_flHeadRadius ) + random->RandomFloat( 0, m_flHeadRadius );
...
void CNPC_Hunter::NPCThink()
{
	...
	m_bPlanted = ( GetEntryNode( GetSequence() ) == m_nPlantedNode );
...
void CNPC_Hunter::StartTask( const Task_t *pTask )
{
	switch ( pTask->iTask )
	{
		...
		case TASK_HUNTER_STAGGER:
		{
			...
			SetPoseParameter( m_nStaggerYawPoseParam, flStaggerYaw );
...
Vector CNPC_Hunter::Weapon_ShootPosition( )
{
	...
	GetAttachment( m_nTopGunAttachment, gunMatrix );
...
void CNPC_Hunter::TraceAttack( const CTakeDamageInfo &inputInfo, const Vector &vecDir, trace_t *ptr )
{
		 ...
		 ( info.GetDamageType() & DMG_NEVERGIB ) )
	{
		...
		else if ( ( info.GetDamageType() & DMG_BULLET ) || ( info.GetDamageType() & DMG_NEVERGIB ) )
		{
			...
			if( info.GetAmmoType() == GetAmmoDef()->Index("ASW_DEAGLE") )
			{
				flScale = 1.16f;
			}
			else
		...
		DispatchParticleEffect( "blood_impact_synth_01_arc_parent", PATTACH_POINT_FOLLOW, this, m_nHeadCenterAttachment );
	}
...
void CNPC_Hunter::BleedThink()
{
	...
	Vector vecOrigin;
	QAngle angDir;
	GetAttachment( m_nHeadCenterAttachment, vecOrigin, angDir );
	
	Vector vecDir = RandomVector( -1, 1 );
	VectorNormalize( vecDir );
	VectorAngles( vecDir, Vector( 0, 0, 1 ), angDir );

	vecDir *= m_flHeadRadius;
...
void CNPC_Hunter::StartBleeding()
{
	...
	DispatchParticleEffect( "blood_drip_synth_01", PATTACH_POINT_FOLLOW, this, m_nHeadBottomAttachment );
...
bool CNPC_Hunter::ShootFlechette( CBaseEntity *pTargetEntity, bool bSingleShot )
{
	...
	if ( m_bTopMuzzle )
	{
		GetAttachment( m_nTopGunAttachment, vecSrc, angMuzzle );
		DoMuzzleFlash( m_nTopGunAttachment );
	}
	else
	{
		GetAttachment( m_nBottomGunAttachment, vecSrc, angMuzzle );
		DoMuzzleFlash( m_nBottomGunAttachment );
	}
...
void CNPC_Hunter::DrawDebugGeometryOverlays()
{
	...
	{	
		...
		if ( ( GetEntryNode( nSeq ) == m_nPlantedNode ) && ( GetExitNode( nSeq ) == m_nPlantedNode ) )
		{
			// planted - green
			NDebugOverlay::Box( GetAbsOrigin(), GetHullMins(), GetHullMaxs(), 0, 255, 0, 128, 0 );
		}
		else if ( ( GetEntryNode( nSeq ) == m_nUnplantedNode ) && ( GetExitNode( nSeq ) == m_nUnplantedNode ) )
		{
			// unplanted - blue
			NDebugOverlay::Box( GetAbsOrigin(), GetHullMins(), GetHullMaxs(), 0, 0, 255, 128, 0 );
		}
		else if ( ( GetEntryNode( nSeq ) == m_nUnplantedNode ) && ( GetExitNode( nSeq ) == m_nPlantedNode ) )
		{
			// planting transition - cyan
			NDebugOverlay::Box( GetAbsOrigin(), GetHullMins(), GetHullMaxs(), 0, 255, 255, 128, 0 );
		}
		else if ( ( GetEntryNode( nSeq ) == m_nPlantedNode ) && ( GetExitNode( nSeq ) == m_nUnplantedNode ) ) 
		{
...
bool CNPC_Hunter::PlayerFlashlightOnMyEyes( CBasePlayer *pPlayer )
{
	Vector vecEyes, vecEyeForward, vecPlayerForward;
 	GetAttachment( m_nTopGunAttachment, vecEyes, &vecEyeForward );
...
void CNPC_Hunter::SetAim( const Vector &aimDir, float flInterval )
{
	...
	float curPitch = GetPoseParameter( m_nBodyPitchPoseParam );
	float curYaw = GetPoseParameter( m_nBodyYawPoseParam );
	...
	SetPoseParameter( m_nAimPitchPoseParam, 0 );
	SetPoseParameter( m_nAimYawPoseParam, 0 );

	SetPoseParameter( m_nBodyPitchPoseParam, clamp( newPitch, -45, 45 ) );
	SetPoseParameter( m_nBodyYawPoseParam, clamp( newYaw, -45, 45 ) );
}
